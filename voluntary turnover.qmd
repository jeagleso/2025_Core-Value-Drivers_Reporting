...
calculate_voluntary_turnover_monthly <- function(grouping_var) {
  ...
  map_df(last_day_of_month, function(date) {
...
calculate_voluntary_turnover_monthly("segment_function")

tmp <- map(grouping_vars, ~ calculate_voluntary_turnover_monthly(.x))
...
# last_day_of_month <- seq.Date(from = as.Date("2025-01-31"), to = as.Date("2025-03-01"), by = "month")
# grouping_var <- "segment_function"

# calculate_voluntary_turnover("segment_function")
